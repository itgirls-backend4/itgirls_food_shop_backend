...
public class OrderController {
    ...
    public void updateOrderStatus(
            @Parameter(description = "id заказа", required = true) @RequestParam(value = "orderId") String orderId,
            @Parameter(description = "статус заказа", required = true) @RequestParam(value = "statusId") Integer statusId) {
        orderService.updateOrderStatus(UUID.fromString(orderId), statusId);
    }
}
